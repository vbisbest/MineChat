    ...
    public class ChatProcessor
    {
            ...
            try
            {
                ...
                foreach(JProperty currentValue in jsonPayload)
                {
                    ...
                    else if(currentValue.Name == "using" || currentValue.Name == "with")
                    {
                        ...
                        returnMessage = String.Format(returnMessage, list.ToArray());
                    }
        ...
        private static string ProcessChatValue(JToken jsonToken)
        {
            ...
            try
            {
                ...
                {
                    extra = MinecraftStringToAttributedStringJson(jsonToken["extra"].ToString());
                }

                returnMessage = colorValue + italicValue + boldValue + textValue + extra;
