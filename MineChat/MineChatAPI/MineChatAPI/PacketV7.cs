...
namespace MineChatAPI
{
    public class PacketV7 : IPacket
    {
        ...
        public PacketV7(MineStream stream)
        {
            this.stream = stream;
        ...
        private void ReadJoinGame()
        {
            Debug.WriteLine("Join Game");
        }
        ...
        private void SendPluginMessage(string type, string message)
        {
            ...
            pluginMessage.AddRange(stream.WriteRawVarint32((int)PacketType.ClientPluginMessage));
